        ...
        if (state is MessageLoaded) {
          return Consumer<HomeProvider>(builder: (context, homeState, _) {
            return MapboxMap(
              ...
              scrollGesturesEnabled: getValueForScreenType<bool>(
                context: context,
                mobile: !homeState.showMessage,
                desktop: homeState.mapGesture,
              ),
              zoomGesturesEnabled: getValueForScreenType<bool>(
                context: context,
                mobile: !homeState.showMessage,
                desktop: homeState.mapGesture,
              ),
